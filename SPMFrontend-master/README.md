...
| hrManager | immediate to manager role |
| hrAdmin | manages hrmanagers |
| payrollAdmin | pay roll admin |
| rmg(resource management) | resource management |
| companyManagement | manages reporting |
