...
class IndividualGoals extends Component {
  ...
  removeValidationMessage(e) {
    ...
    // }
    if (e.target.name === 'goalSettingScreen_knowledgeManagement_performanceRating') {
      this.setState({ modifyperformanceRatingErrorText: '' });
    }
    if (e.target.name === 'goalSettingScreen_knowledgeManagement_comments') {
  ...
  submit() {
    ...
    const newRows = {};
    newRows.goalText = this.props.data.goalText;
    newRows.startDate = this.props.data.startDate;
    newRows.endDate = this.props.data.endDate;
    newRows.expectedOutcome = this.props.data.expectedOutcome;
    newRows.addedBy = this.props.data.addedBy;
    newRows.weightage = this.props.data.weightage;
    newRows.performanceYear = '2017-2018';
    newRows.performanceRating = form.goalSettingScreen_knowledgeManagement_performanceRating.value;
    newRows.comments = form.goalSettingScreen_knowledgeManagement_comments.value;
    ...
    newRows.performanceRatingField = 'goalSettingScreen_knowledgeManagement_performanceRating';
    newRows.commentsField = 'goalSettingScreen_knowledgeManagement_comments';
    ...
    if (newRows.performanceRating === '') {
      this.setState({ modifyperformanceRatingErrorText: <span>PMGSKM001:  Performance Rating is required {this.errorCodeHelper('PMGSKM001')} </span> });
      isValid = false;
    } if (newRows.comments === '') {
      this.setState({ modifycommentsErrorText: <span>PMGSKM002:  Comments is required {this.errorCodeHelper('PMGSKM002')} </span> });
      isValid = false;
    }
    if (isValid) {
        ...
        <div className="card-footer">
          <form name="knowledgeManagement" >
            ...
            <div>
              ...
              <input type="text" name="goalSettingScreen_knowledgeManagement_performanceRating" defaultValue={this.props.data.performanceRating} className="entry-input" onChange={this.removeValidationMessage} />
              <div className="custom-error">
            ...
            <div>
              ...
              <input type="text" name="goalSettingScreen_knowledgeManagement_comments" defaultValue={this.props.data.comments} className="entry-input" onChange={this.removeValidationMessage} />
              <div className="custom-error">
