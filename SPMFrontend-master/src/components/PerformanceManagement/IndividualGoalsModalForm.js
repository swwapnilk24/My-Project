        ...
        <div className="card-footer">
          <form name="individualGoalFields" >
            ...
            <div>
              ...
              <select className="custom-select" name="goalSettingScreen_individualGoals_expectedOutcome" defaultValue={this.props.data.expectedOutcome} onChange={this.removeValidationMessage} >
