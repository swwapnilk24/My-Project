...
/**
 * A View Component For dispalying Pensions, Savings and Retirement Plans Benefits of an employee.
 *
 */
class PSRPlansViewForm extends Component {
  constructor(props) {
    super(props);
  ...
  changeCodeToName(codeNames, typeCode) {
    let typeName = '';
    console.log('codenamees', codeNames);
    codeNames.map((obj) => {
      if (obj.status === 'Active' && obj.code === typeCode) {
        typeName = obj.name;
    ...
    return (
      <div className="card">
        <div className="card-header">
          Pensions / Savings / RetirementPlans
          ...
          <table className="table table--stripes">
            <tbody>
              <tr>
                ...
                <td>
                  {this.changeCodeToName(this.props.planTypeNames, this.props.data.allowanceType)}
...
export default connect(mapStateToProps)(PSRPlansViewForm);
