...
import { recalculateBudget, addEmployee, updateEmployee, removeEmployee } from '../../actions/OrgchartAction';
...
class Organisation extends React.Component {
  constructor(props) {
    ...
    this.state = { myModel: null, myDiagram: null, data: rawData, volume: 100, selectedOption: 'master', meritVolume: 80, ltiVolume: 90 };
  }
  ...
  reloadCanvas() {
    ...
    document.getElementById('masterSlider').style.display = 'block';
    document.getElementById('meritSlider').style.display = 'none';
    document.getElementById('ltiSlider').style.display = 'none';
  }
  ...
  handleOptionChange(event) {
    ...
    if (event.target.value === 'merit') {
      console.log('merit');
      document.getElementById('masterSlider').style.display = 'none';
      document.getElementById('ltiSlider').style.display = 'none';
      document.getElementById('meritSlider').style.display = 'block';
    }
    if (event.target.value === 'lti') {
      document.getElementById('masterSlider').style.display = 'none';
      document.getElementById('ltiSlider').style.display = 'block';
      document.getElementById('meritSlider').style.display = 'none';
    }
    this.setState({
      ...
      <div className="container">
        <div className="row">
          <div className="col-xs-12">
            <input type="radio" name="master" value="master" onChange={this.handleOptionChange} checked={this.state.selectedOption === 'master'} /> Master &nbsp;
            <input type="radio" name="merit" value="merit" onChange={this.handleOptionChange} checked={this.state.selectedOption === 'merit'} /> Merit &nbsp;
            <input type="radio" name="sti" value="sti" onChange={this.handleOptionChange} checked={this.state.selectedOption === 'sti'} /> STI  &nbsp;
            <input type="radio" name="lti" value="lti" onChange={this.handleOptionChange} checked={this.state.selectedOption === 'lti'} /> LTI
          </div>
        </div>
        <div className="row">
          <div className="col-xs-12">
            <div className="slider" id="masterSlider">
              <Slider
                min={1}
                max={200}
                width={300}
              ...
              />
              <span className="slider_value">{this.state.volume}</span>
            </div>
            <div className="slider" id="meritSlider">
              <Slider
                ...
                max={800}
                width={500}
                value={this.state.meritVolume}
                onChangeStart={this.handleMeritChangeStart}
                onChange={this.handleMeritChange}
                onChangeComplete={this.handleMeritChangeComplete}
              />
              <span className="slider_value">{this.state.meritVolume}</span>
            </div>
            <div className="slider" id="ltiSlider">
              <Slider
                min={1}
                max={800}
                width={500}
                value={this.state.ltiVolume}
                onChangeStart={this.handleLTIChangeStart}
                onChange={this.handleLTIChange}
                onChangeComplete={this.handleLTIChangeComplete}
              />
              <span className="slider_value">{this.state.ltiVolume}</span>
            </div>
            <div ref={(goJsDiv) => { this.goJsDiv = goJsDiv; }} style={{ height: '600px', backgroundColor: '#FFFFFF' }} />
          </div>
          <TreeList data={this.state.data} columns={COLUMNS} options={OPTIONS} id={'key'} parentId={'parent'} />
          <Modal
